...
export const getSchemaDetails = async (schemaId = "", token = accessToken) => {
  try {
...
export async function getBQDefinition(bqId = "", token = accessToken) {
  try {
    var res = await axios.get(
...
export async function getAdhocVAlue(querry) {
  try {
